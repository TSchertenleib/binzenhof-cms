    ...
    <div class="anfragen">
      <h3>FÜR INFOS, UNVERBINDLICHE ANFRAGEN ODER RESERVATIONEN</h3>



      <a class="mail" href="mailto:peter.knoerr@bluewin.ch?Subject=Neue Anfrage von Binzenhof.ch" target="_top">info@binzenhof.ch</a>
    </div>
